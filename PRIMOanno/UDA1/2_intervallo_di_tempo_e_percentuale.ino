// ESPERIMENTO PER MISURARE CON OSCILLOSCOPIO LA DURATA DI UN EVENTO e lavorare con la PERCENTUALE
...
// 4) RISOLVI - usiamo l'oscilloscopio per la misura dell'intervallo di tempo di un ciclo e la durata del segnale "1"
