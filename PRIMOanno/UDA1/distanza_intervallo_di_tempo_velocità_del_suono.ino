...
// ESPERIMENTO di calcolo della velocità del suono

// Materiale: vedere i due esperimenti precedenti

// OBIETTIVO: calcolare la velocità del suono 

// PROCEDURA: Collegare il segnale echo all'oscilloscopio (e le messe a Terra in comune),
//            misurare l'intervallo di tempo e dividerlo per due; 
//            dividere la distanza per l'intervallo di tempo e verificare che escono circa 340 m/s
